...
def eval_phase(model, tokenizer, config, csv_file, params=params):# params, which_files="test", model=None):
    ...
    input_test_ids, att_masks_test = combine_features(
        sentences_test, tokenizer, 512# params["max_length"]
    )
